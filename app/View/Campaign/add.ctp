...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading"> Add Business Unit </h1>
        </div>
...
<div class="content">
    <div class="block block-content">
        <form class="form-horizontal js-validation-bootstrap" action="<?php echo $this->Neo->u( 'campaigns', 'add' ); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="" data-date-format="mm/dd/yyyy" name="start_date" id="start_date" style="width:100%;" class="js-datepicker form-control col-sm-4 required" value="<?php echo $market['Market']['start_date'] ? toUi( $market['Market']['start_date'] ) : "01/01/$currentyr"; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" placeholder="" data-date-format="mm/dd/yyyy" name="end_date" id="end_date" style="width:100%;" class="js-datepicker form-control col-sm-4 required" value="<?php echo $market['Market']['end_date'] ? toUi( $market['Market']['end_date'] ) : "12/31/$currentyr"; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    foreach( AppConstants::$validationDays as $k => $v ) {
                        echo '<input type="checkbox"  name="validation_week_days[]" id="validation_week_days" class="required" value="' . $k . '"> ' . $v . '   ';
                    }
                    ?>
                    <br><br><label id="validation_week_days-error" class="text-danger" for="validation_week_days" style="display:none"></label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <br><br><label id="validation_week_days-error" class="text-danger" for="pixel_file" style="display:none"></label>
