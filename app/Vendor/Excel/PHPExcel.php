...
class PHPExcel
{
	...
	*/
    ...
    {
        if ( isset( $this->_cellXfCache[$pValue] ) && isset( $this->_cellXfCollection[$this->_cellXfCache[$pValue]] ) ) {
            return $this->_cellXfCollection[$this->_cellXfCache[$pValue]];
        }
        foreach ($this->_cellXfCollection as $cellKey => $cellXf) {
            if ($cellXf->getHashCode() == $pValue) {
                $this->_cellXfCache[$pValue] = $cellKey;
                return $cellXf;
            }
        }
        return false;
